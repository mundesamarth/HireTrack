  ...
  setIsModalOpen: (value: boolean) => void;
    ...
    return(
        <div className="text-foreground-1 rounded-[6px] mt-[20px]" >
            <Button className={cn("bg-foreground-1 w-full text-background overflow-hidden whitespace-nowrap transition-all duration-300 ease-in-out cursor-pointer py-6", isCollapsed ? " hover:cursor-pointer bg-foreground-1 ": "bg-foreground-1")} onClick={() =>setIsModalOpen(true)}>
